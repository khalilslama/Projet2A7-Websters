            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div style="background:rgba(2, 0, 139, 0.6);" class="product-status-wrap">
                    ...
                    <div class="custom-pagination">
                     <div class="input-group mg-b-pro-edt" style="width:20%;">
                     <span class="input-group-addon"><i class="fa fa-search"></i></span>
                     <input style="border-radius:4px;" type="text" class="form-control" id="myInput" onkeyup="myFunction()" placeholder="Search for names.." >
                      </div>
...
<div class="footer-copyright-area">
    ...
    <!-- main JS
      ...
      <script type="text/javascript">
                ...
                function fetch(tri,search,lol1,lol2)
                {
                ...
                method:"POST",
                url:"reload.php",  
                data:{order:order,col:XD,collect:cole,by:by},   
