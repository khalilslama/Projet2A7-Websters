    ...
    <div class="all-content-wrapper">
        ...
        <div class="product-status mg-b-30">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div style="background:rgba(2, 0, 139, 0.6);" class="product-status-wrap">
                            <h4>Products List</h4>
                            ...
                            <div class="custom-pagination">
                                ...
                                <form method="POST" action="createpdf.php"><button class="pdf" name="pdf" style="float:right; padding: 5px 10px;font-size: 14px;border-radius: 3px;border: 1px solid rgba(0,0,0,.12);background: #152036;"><i class="fa fa-file-pdf-o text-info"></i></button></form>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script type="text/javascript">
        $(".delete").click(function(){
            ...
            if(confirm("voulez-vous supprimer cet article ?"))
            {
                ...
                {  
                   $("#lol").load("reload.php", {product : 1});
               }  
            });
            } 
          });
        $(".pd-setting").click(function(){
               var reference=$(this).attr('value');
               var id=$(this).attr('id');
               var collection=0;
            if(confirm("voulez-vous modifier le status cet article ?"))
            {
                $.ajax({
                method:"POST",
                url:"modifierstatus.php",  
                data:{reference:reference,id:id,collection:collection},   
                success:function(data)
                {  
                    $("#lol").load("reload.php", {product : 1});
               }  
