	...
	function afficherCollectionF()
	{
		...
		$db = config::getConnexion();
				...
				<div class="swiper-image">
					<button classe="idco" onclick="showpic(this.id)"; style="border:none;background-color:transparent;" type="submit" name="send" id="'.$row['idcollection'].'" value="'.$row['idcollection'].'"><img src="../nalika-master/nalika/image/'.$row['image'].'"></button>
				</div>
			</div>'; 			
				}
