                ...
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
                        ...
                        <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="Bar Charts" href="stat.php"><span class="mini-sub-pro">Inscription</span></a></li>
  ...
  <div class="tableau">
   <div class="panel panel-default">
    <div class="panel-heading">
     <div class="row">
      <div class="col-md-6">
       <h3 class="panel-title">Client inscrit</h3>
      </div>
     </div>
    </div>
...
$(document).ready(function(){
 ...
 $(document).on('click', '.view', function(){
  ...
  new Dialogify('../core/fetch_single_data.php',options)
 ...
 $(document).on('click', '.update', function(){
  var id = $(this).attr('id');
  $.ajax({
   url:"../core/fetch_single.php",
   method:"POST",
   data:{id:id},
   dataType:'json',
   success:function(data)
   {
    localStorage.setItem('Tourpoitrine', data[0].Tourpoitrine);
    localStorage.setItem('tourtaille', data[0].tourtaille);
    localStorage.setItem('tourbassin', data[0].tourbassin);
    localStorage.setItem('L_taille', data[0].L_taille);
    localStorage.setItem('H_poitrine', data[0].H_poitrine);
    localStorage.setItem('E_poitrine', data[0].E_poitrine);
    localStorage.setItem('Carruredos', data[0].Carruredos);
    localStorage.setItem('Carruredevant', data[0].Carruredevant);
    localStorage.setItem('L_epaule', data[0].L_epaule);
    localStorage.setItem('Grosseurbras', data[0].Grosseurbras);
    localStorage.setItem('Tourpoignet', data[0].Tourpoignet);
    localStorage.setItem('Hauteurgenou', data[0].Hauteurgenou);
    localStorage.setItem('L_taille_terre', data[0].L_taille_terre);
    localStorage.setItem('Longeurtotale', data[0].Longeurtotale);
     ...
     .buttons([
      ...
      },
      {
       ...
       click:function(e)
       {
        ...
        form_data.append('Tourpoitrine', $('#Tourpoitrine').val());
        form_data.append('tourtaille', $('#tourtaille').val());
        form_data.append('tourbassin', $('#tourbassin').val());
        form_data.append('L_taille', $('#L_taille').val());
        form_data.append('H_poitrine', $('#H_poitrine').val());
        form_data.append('E_poitrine', $('#E_poitrine').val());
        form_data.append('Carruredos', $('#Carruredos').val());
        form_data.append('Carruredevant', $('#Carruredevant').val());
        form_data.append('L_epaule', $('#L_epaule').val());
        form_data.append('Grosseurbras', $('#Grosseurbras').val());
        form_data.append('Tourpoignet', $('#Tourpoignet').val());
        form_data.append('Hauteurgenou', $('#Hauteurgenou').val());
        form_data.append('L_taille_terre', $('#L_taille_terre').val());
        form_data.append('Longeurtotale', $('#Longeurtotale').val());
        form_data.append('id', data[0].Id);
        $.ajax({
         method:"POST",
         url:'../core/update_data.php',
         data:form_data,
         dataType:'json',
         contentType:false,
         cache:false,
