...
<div class="container">
  <form method="GET" action="ajoutfaq.php">
      <h1 class="b" align="center">Ajouter des Q/R</h1>
      <br>
    <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
        <textarea id="subject" name="question" placeholder="question.." required="required" style="height:200px"></textarea>
      </div>
    </div>
        <div class="row">
      <div class="col-25">
        <label for="subject">reponse</label>
      </div>
      <div class="col-75">
        <textarea id="subject" name="reponse" placeholder="reponse.." required="required" style="height:200px"></textarea>
      </div>
    </div>
    <div class="row">
