...
if (isset($_GET['id'])){
    $faqc=new faqc();
    $result=$faqc->recupererfaq($_GET['id']);
...
?>
<form method="POST" style="margin: 0 0 0 100px " action="mofiffaq.php">
...
<tr>
<td>reponse</td>
<td><input type="text" name="reponse" value="<?PHP echo $reponse ?>"></td>
</tr>
